...
if __name__ == '__main__':
    ...
    for file in sorted(video_files, key=os.path.getmtime):
        ...
        if not skip_iter:
            ...
            command = "python inference.py --exp-cfg data/conf.yaml --datasets openpose --exp-opts datasets.body.batch_size 1 datasets.body.openpose.data_folder " + OUTPUT_SKELETON_PATH + "/" + vid + " --show False --output-folder " + expose_out + " --save-params True --save-vis False --save-mesh False"
            print(command)
